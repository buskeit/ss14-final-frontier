...
namespace Content.Client.VendingMachines.UI
{
    ...
    public sealed partial class VendingMachineMenu : FancyWindow
    {
        ...
        /// </summary>
        public void Populate(List<VendingMachineInventoryEntry> inventory, Dictionary<string, int> prices, bool requiresCash, bool enabled)
        {
            _enabled = enabled;
            _prices = prices;
        ...
        /// </summary>
        public void UpdateAmounts(List<VendingMachineInventoryEntry> cachedInventory, Dictionary<string, int> prices, bool requiresCash, bool enabled)
        {
            _enabled = enabled;
            _prices = prices;
            _requiresCash = requiresCash;
        ...
        private void UpdateBalanceDisplay()
        {
            ...
            if (_playerManager.LocalEntity is { } player)
                _entityManager.System<Content.Client.Bank.BankSystem>().TryGetBalance(player, out balance);

            BalanceLabel.Text = $"Balance: {BankSystemExtensions.ToSpesoString(balance)}";
