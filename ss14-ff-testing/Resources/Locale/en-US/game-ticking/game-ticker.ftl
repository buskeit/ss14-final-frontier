...
game-ticker-player-join-game-message = Welcome to the Aurelian Reach: Report bugs on our Discord!
game-ticker-get-info-text = SS14 The Final Frontier: Initial Release! Discover the mysteries of the Aurelian Reach. Create entire stations from scratch with custom assignments and access.
game-ticker-get-info-preround-text = Welcome to the Aurelian Reach: A persistent SS 14 HRP+ Experience for players aged 18+.
