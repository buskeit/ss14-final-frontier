...
genpop-prisoner-id-examine-wait = You have served {$served} of your {$sentence} sentence for {$crime}.
...
genpop-locker-ui-label-sentence = [bold]Sentence length in days:[/bold] [color=gray](0 for permanent)[/color]
genpop-locker-ui-sentence-placeholder = 0-99999 days
genpop-locker-ui-sentence-tooltip = Enter a whole number of days from 0 to 99,999. Zero creates a permanent sentence.
